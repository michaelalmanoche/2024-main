...
const OperatorForm = () => {
  ...
  const [selectedRole, setSelectedRole] = useState('Operator'); // State for selected role
  ...
  return (
    <div className="container mx-auto p-4 flex flex-col items-center">
     ...
     {/* Register Modal */}
     <Modal isOpen={isRegisterModalOpen} onClose={handleRegisterModalClose} title="">
      <form onSubmit={handleRegisterSubmit} className="space-y-8 p-2 sm:p-2" >
      <div className="flex justify-start items-center border-b pb-1 
      rounded-t  sm:mb-5 dark:border-gray-600 mt-[-3rem]">
          <h1 className="mr-2">Register :</h1>
          <select value={selectedRole} onChange={handleRoleChange} 
          className="bg-gray-50 border-2 border-gray-300 text-gray-900
          text-sm rounded-lg block p-2.5 placeholder-gray-400
           focus:border-green-600 focus:outline-none uppercase">
